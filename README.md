...
<div class="box">
    ...
    <div id="scriptbox">
        ...
        <div class="tooltip-box tooltip" data-tooltip="adornyouracorn.js v1 + html2pdf.js v0.9.2 (c) 2020 Erik Koopmans. Released under the MIT License.">
            <textarea rows=4 cols=42 id="codeblock"></textarea>
        </div>
    </div>
</div>

**Step 1:** Click the Squirrels to get [the](https://github.com/nkhi/adorn-your-acorn/blob/main/src/bookmarklet.js) [script](https://ekoopmans.github.io/html2pdf.js/).  
