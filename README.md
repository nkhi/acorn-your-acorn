...
<div class="box">
    ...
    <div title="click here to Copy" id="copy-button" class="copy-link tooltip" onClick="copyPrintPDFCode();" data-tooltip="This script converts your open tab into a PDF"></div>
</div>
