...
<div class="box">
    ...
    <div class="tooltip" data-tooltip="html2pdf.js v0.9.2. Copyright (c) 2020 Erik Koopmans. Released under the MIT License.">
        <textarea rows=6 cols=60 id="codeblock"></textarea>
    </div>
</div>
