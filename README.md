...
<div class="box">
    ...
    <a title="click here to Copy" class="copy-link tooltip" onClick="copyPrintPDFCode();" data-tooltip="This script converts your open tab into a PDF">
        <div class="copy-button css-selector">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#000000" viewBox="0 0 256 256" style="filter: invert();"><rect width="256" height="256" fill="none"></rect><polygon points="168 87.993 168 167.993 216 167.993 216 39.993 88 39.993 88 87.993 168 87.993" opacity="0.2"></polygon><polyline points="168 167.993 216 167.993 216 39.993 88 39.993 88 87.993" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline><rect x="39.99902" y="87.99414" width="128" height="128" stroke-width="16" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" fill="none"></rect></svg>
        </div>
    </a>
</div>
