...
<div class="box">
    ...
    <div onClick="copyPrintPDFCode();" id='codebox' class="css-selector tooltip-box tooltip" data-tooltip="html2pdf.js v0.9.2. Copyright (c) 2020 Erik Koopmans. Released under the MIT License.">
...
<script>
  ...
  function copyPrintPDFCode() {
        ...
        el.value = document.getElementById('codebox').value;
